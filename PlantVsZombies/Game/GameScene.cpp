...
#define DEVZ(n) { ZombieType::n, #n }
	...
	const std::vector<std::pair<ZombieType, const char*>> kDevZombieTable = {
		...
		DEVZ(ZOMBIE_AURORA_PRIEST), DEVZ(ZOMBIE_POLAR_CLOCKMAKER), DEVZ(ZOMBIE_EXCAVATOR), DEVZ(ZOMBIE_CRYSTAL_HORN_MINER), DEVZ(ZOMBIE_SUN_THIEF), DEVZ(ZOMBIE_CRYSTAL_DRUMMER), DEVZ(ZOMBIE_ICE_WORKER)
	};
#undef DEVZ
